					...
					Segun r3 Hacer
						...
						3:
							...
							Para i<-1 Hasta lvls Con Paso 1 Hacer
								...
								bs <- (((endLvl - p) / 2) + 1)
								// bs = blank space
								//Cálculo de los espacios en blanco del lado izquierdo de la línea:
								Para l<-1 Hasta bs Con Paso 1 Hacer
									// l = left = izquierda
									lvl<-lvl + " "
								FinPara
								//Cálculo de los asteriscos en el centro de la linea:
								Para c<-1 Hasta p Con Paso 1 Hacer
									// c = center = centro
									lvl<-lvl + "*"
								FinPara
								//Cálculo de los espacios en blanco del lado derecho de la línea:
